...
void merge_coupleshistos(const char* eospath, const int brickID, const int platenumber){ // EOSPATH=/path/to/RUN
 //histo file
 TFile *histofile = new TFile(Form("goodcoupleshistos_cells%i.root",platenumber),"RECREATE");  
 ...
 TString prepath(Form("%sb%0*i/p%0*i/%i.%i.",eospath,6,brickID,3,platenumber,brickID, platenumber));
