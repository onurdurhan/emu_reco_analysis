...
root -b -q -l $path '/afs/cern.ch/user/o/onur/emulsion_tasks2/quality_checks/check_raw.C(1)'
root -b -q -l $path '/afs/cern.ch/user/o/onur/emulsion_tasks2/quality_checks/thickness.C'
